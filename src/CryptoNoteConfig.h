...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 70;
const size_t   CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW          = 7;
const uint64_t CRYPTONOTE_BLOCK_FUTURE_TIME_LIMIT            = 360; // 60 * 60 * 2;
